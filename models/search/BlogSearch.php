...
/**
 * BlogSearch represents the model behind the search form about `alkurn\cms\models\CmsItem`.
 */
class BlogSearch extends CmsItem
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['type_id' => self::TYPE_BLOG,]);
